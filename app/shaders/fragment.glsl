...
// its similar to c
// this is for colors of each vertex
// varying  type is used to make a variable available in both vertex and fragment shader files, while uniform don't change, attribute change in the file
